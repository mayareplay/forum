...
function check_in_group($ckid){
	...
	$tmp = explode("\t",$_G['member']['extgroupids']);
	if(in_array($ckid,$tmp)){
		return true;
	}
	return false;
...
function check_xiaobian(){
	...
	$ext_group = $_G['config']['ext_system']['manage_group'];
  
	return check_in_group($ext_group);
}
