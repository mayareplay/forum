...
if(!submitcheck('topicsubmit', 0, $seccodecheck, $secqaacheck)) {
	...
	if($special == 4) {
	   ...
	   */
  		...
  		$activity = array('starttimeto' => '', 'starttimefrom' => '', 'place' => '', 'class' => '', 'cost' => '', 'number' => '', 'gender' => '', 'expiration' => '','expiration' => '','ext_firends'=>1,'ext_needverifiy'=>1,'ext_credit_2'=>0,'tipmsg'=>'','ext_jingpaitype'=>0,'ext_jingpai'=>'','ext_jiangnum'=>0);
		$activitytypelist = $_G['setting']['activitytype'] ? explode("\n", trim($_G['setting']['activitytype'])) : '';
    ...
    $params['tstatus'] = defined('IN_MOBILE')?1024:0;
